...
if __name__ == "__main__":
    ...
    print('done')
    """
    create_labelled_tree(data_file='data_files/genome_lineage.csv', labels_file='data_files/subproblems/Firmicutes_erythromycin_0.0/erythromycin_firmicutes_samples.csv')
    print("done")
