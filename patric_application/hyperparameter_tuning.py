...
parser.add_argument('--dpfs', type=float, nargs='+', default=[0.00001, 0.0001, 0.001, 0.01, 0.1], help='Default is [0.001, 0.01, 0.1, 1.0]')
parser.add_argument('--lrs', type=float, nargs='+', default=[0.01, 0.001, 0.0001], help='Default is [0.01, 0.001, 0.0001]')
parser.add_argument('--l1s', type=float, nargs='+', default=[0.1], help='Default is [0.0, 0.01, 0.1, 1.0]')
